    ...
    fetch(`/api/competitions/${competitionId}`)
      ...
      .then((data) => {
        setForm({
          ...
          initialSeedMoney:
            data.initialSeedMoney != null ? String(data.initialSeedMoney) : "",
          maxParticipants:
            data.maxParticipants != null ? String(data.maxParticipants) : "",
        });
      })
      .catch((err) => {
        console.error("대회 수정 정보 조회 오류:", err);
...
const toDateTimeLocalValue = (dateTimeString) => {
